...
MAINTAINER_EMAIL = "tallon1997r@gmail.com"
#URL = ""
DOWNLOAD_URL = "https://pypi.org/project/haredis/#files"
LICENSE = "Apache 2.0"
PROJECT_URLS = {
    "Bug Tracker": "https://github.com/haredis/haredis-py/issues",
    # "Documentation": "https://www.haredis.com",
    "Source Code": "https://github.com/haredis/haredis-py",
}
...
def setup_package():
    ...
    metadata = dict(
        ...
        keywords=["redis", "aioredis", "lock-release", "high availability", "distributed systems", "streaming api"],
