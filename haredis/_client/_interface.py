"""Haredis Redis Client Implementation."""
import abc
import logging
...
class AbstractHaredisClientSetter(abc.ABC):
    """
    Abstract Setter class for HaredisClientBuilder class.
    """
...
class AbstractHaredisClientBuilder(abc.ABC):
    """
    Abstract haredis client builder class for redis sync api.
    """
...
class AbstractHaredisClientCmdExecutor(abc.ABC):
    """
    Abstract haredis client class for redis sync api.
    """
    ...
    @abc.abstractmethod
    def xproduce(self, stream_name: str, data: dict, max_messages: int, maxlen: int, stream_id: str):
        """
    ...
    @abc.abstractmethod     
    def create_consumer_group(self, stream_name: str, group_name: str, mkstream: bool, id: str):
        """
