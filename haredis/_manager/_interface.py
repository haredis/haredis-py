...
class AbstractBaseHaredisManager(abc.ABC):
    ...
    def partial_main_selector(
        ...
        """Select partial main function parameter
    ...
    def partial_main_selector_pubsub(
        ...
        """Select partial main parameter w/pubsub
...
class AbstractLockReleaseManager(abc.ABC):
    """## Redis Lock Release Manager Class for Distributed Caching/Locking in Redis
    This class is used to implement distributed locking in redis using streams and pub/sub api (For syncronous execution).
    """
    ...
    def lock_release_with_stream(   
        ...
        **kwargs: dict
        ...
        """haredis distributed locking algorithm implementation in redis using stream api xread/xadd (For both syncronous execution).
    ...
    async def lock_release_with_pubsub(   
        ...
        **kwargs
        ...
        """haredis distributed locking algorithm implementation in redis using pub/sub api (For both syncronous execution).
